...
const confirmationCopy = {
  "kitchen-application": {
    ...
    description: "Ekoraa will review the fit details and contact the decision-maker about the one-month pilot.",
  ...
  order: {
    ...
    description: "Ekoraa will check the current menu, price and fulfilment details before anything becomes a confirmed order.",
  ...
  "group-order": {
    ...
    description: "Ekoraa will review the headcount, timing and location, then return with live availability and a coordinated quote.",
  ...
  contact: {
    ...
    description: "Ekoraa will route it to the person handling that topic and reply through the contact details you provided.",
  ...
  preferences: {
    ...
    description: "Ekoraa will update the matching contact record with the channels—or withdrawal—you selected.",
