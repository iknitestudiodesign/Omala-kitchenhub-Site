...
export default function MarketingNoticePage() {
  return <LegalPage {...siteCopy.pages.marketingNotice.hero}>
    <h2>Separate channel choices</h2><p>Ekoraa asks separately for WhatsApp, SMS and email permission. Choices are unticked by default. Agreeing to one channel does not agree to the others, and promotion is not required to place an order or apply as a kitchen.</p>
    ...
    <h2>What you may receive</h2><p>Selected channels may receive daily menus, participating-kitchen updates, group-order ideas, offers and Ekoraa pilot news. Frequency will depend on the selected programme and active kitchen menus.</p>
    ...
    <h2>Existing contact lists</h2><p>Ekoraa will not treat possession of a phone number as permission. Existing kitchen or campaign contacts must have documented, lawful outreach provenance before promotional use.</p>
