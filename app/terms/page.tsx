...
export default function TermsPage() {
  return <LegalPage {...siteCopy.pages.terms.hero}>
    <h2>About the pilot</h2><p>Ekoraa Kitchen Hub coordinates customer communication and order information between customers and participating kitchens. The pilot website does not promise nationwide availability, guaranteed kitchen growth, a live marketplace, an Ekoraa-owned delivery fleet or automatic payment processing.</p>
    ...
    <h2>Kitchen applications</h2><p>An application is an invitation to discuss the one-month pilot, not a promise of acceptance or a final commercial contract. A kitchen must have an authorised decision-maker and a lawful basis for any customer contacts later introduced to Ekoraa.</p>
    <h2>Availability and changes</h2><p>Menus, prices, service hours and fulfilment can change. Ekoraa may correct information, pause a request flow or decline an unsafe, unlawful or impractical request.</p>
