...
export default function PrivacyPage() {
  return <LegalPage {...siteCopy.pages.privacy.hero}>
    <h2>Who is responsible</h2><p>Ekoraa Kitchen Hub determines why and how personal information submitted through this website is used. You can reach the team through the <Link href="/contact">contact form</Link> and select “Privacy or data request.”</p>
    ...
    <h2>Service providers and transfers</h2><p>Ekoraa plans to use GoHighLevel as the operational customer and order system, Railway for website hosting, and Cloudflare Turnstile for form protection when enabled. These providers may process information outside Cameroon. Ekoraa will document the applicable contractual and legal safeguards before production launch.</p>
    ...
    <h2>Changes</h2><p>Ekoraa may update this pilot notice as the service, providers and legal review develop. The date above shows the current version.</p>
  </LegalPage>;
}
