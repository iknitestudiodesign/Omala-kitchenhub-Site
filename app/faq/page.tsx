...
const customerFaqs = [
  ["Is my website request already a confirmed order?", "No. Ekoraa first checks the live menu, price, availability and fulfilment plan. The order is confirmed only after you receive those details and accept them."],
  ...
  ["Does Ekoraa deliver the food?", "During the pilot, fulfilment may be handled by the kitchen, a delivery partner, the customer or pickup. Ekoraa confirms the method for each order and does not claim to own a delivery fleet."],
  ["What if I do not know which kitchen to choose?", "Choose “Let Ekoraa match my request.” We will look for a verified kitchen that fits the meal, area and timing."],
...
const kitchenFaqs = [
  ["What does Ekoraa handle?", "Ekoraa handles agreed customer outreach, initial questions, order information, confirmations, service updates, customer organisation, feedback and reporting."],
  ...
  ["Do I need a customer list?", "Ekoraa works best when a kitchen has customers or an audience it is lawfully allowed to contact. We ask about the source during qualification, but never accept customer-list uploads through the public application form."],
  ["Will Ekoraa post as if I personally wrote every message?", "Communication can carry the kitchen’s approved voice, but Ekoraa will not make deceptive claims about who personally wrote a message. Our privacy information also explains where automation supports the service."],
...
export default function FaqPage() {
  return (
    <>
      ...
      <CtaBand eyebrow="Still deciding?" title="Tell us the question behind the question." description="We’ll respond about an order, kitchen application or general Ekoraa enquiry." primaryHref="/contact" primaryLabel="Contact Ekoraa" secondaryHref="/how-it-works" secondaryLabel="Review the flow" />
    </>
  );
}
