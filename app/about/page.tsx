  ...
  return (
    <>
      <PageHero
        ...
        actions={<><Link className="button button--accent" href="/for-kitchens#apply">Build with Ekoraa <ArrowRight size={17} /></Link><Link className="button button--ghost-light" href="/how-it-works">See how it works</Link></>}
        ...
        <div className="shell two-column-copy">
          ...
          <div className="prose">
            ...
            <p>
              ...
              the meal. Ekoraa turns the customer side into a clearer routine.
            </p>
        ...
        <div className="shell group-feature__grid">
          <div className="brand-story-visual">
            <ResponsiveImage
              ...
              avif="/images/brand/ekoraa-packaging-concept.avif"
              fallback="/images/brand/ekoraa-packaging-concept.png"
              alt="Two white Ekoraa-branded takeaway boxes shown in an early packaging concept"
              width={1800}
              height={1200}
            />
            <p className="media-caption">Early Ekoraa packaging concept from the brand archive.</p>
          </div>
          <div>
            <SectionIntro
              eyebrow="Brand heritage"
              title="A food experience people can recognise and trust."
              description="Ekoraa has always been about the moment around the meal: a clear promise, thoughtful presentation and a warm connection between kitchen and customer."
            />
            <div className="prose-note">
              This archival mockup communicates the brand direction. It does not promise that every pilot order will use Ekoraa-branded packaging; each kitchen remains responsible for safe, suitable packaging during the pilot.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="content-section">
        <div className="shell group-feature__grid">
          <div>
            <SectionIntro eyebrow="Starting in Buea" title="Learn locally, prove the flow, then earn the right to grow." description="The first Ekoraa release is deliberately focused. A smaller service area lets the team understand real kitchen operations, order patterns and fulfilment constraints before expanding the promise." />
      ...
      <section className="content-section content-section--tint">
        <div className="shell">
          ...
          <div className="content-grid-3" style={{ marginTop: 45 }}>
            <article className="content-card"><span className="icon-tile"><HeartHandshake size={22} /></span><h3>Human relationships first</h3><p>Ekoraa should feel like reliable support around the kitchen, not a faceless replacement for it.</p></article>
